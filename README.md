...
5. Коммутативное шифрование: сундук и речка, [Pohlig-Hellman](https://www.cs.purdue.edu/homes/ninghui/courses/Fall04/lectures/lect15.pdf). Протокол игры в покер по телефону.
...
Эта задача является нерешаемой.
...
Задачи, которые уже нельзя сдать
--------------------------------

[Их решения](http://lights-out-ctf.ghost.io/)
